...
return {falsey, truey, play, incrementBlue, incrementRed, ties, incrementTurns, resetTurns}
}
let iPlay = players();
...
function tieCheck(boardArr){
   let check = boardArr.classList.contains("cell") || boardArr.classList.contains("cell2")
      ? true
      : null;
      return check;
};
